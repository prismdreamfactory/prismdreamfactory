      ...
      >
        <div className="page about">
          ...
          <div className="page__container" ref={el => (this.content = el)}>
            ...
            <p>
              Prism Dream Factory is a Los Angeles based marketing strategy
              group that focuses on helping companies scale, go to market,
              penetrate emerging markets, develop products, and enhance services
              for platforms that spread altruism and serve a greater purpose
